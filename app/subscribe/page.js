...
import pic from "../../public/tacos.jpg";
...
const Subscribe = () => {
  ...
  const isFormComplete =
    phone && selectedState && selectedCity && phone.length == 10;
  ...
  return (
    <div className="w-screen h-screen relative flex justify-center items-center">
      ...
      <div className="absolute flex flex-col justify-center items-center bg-transparent backdrop-blur-md border rounded-lg p-6 m-10 max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full ">
          ...
          <button
            type="submit"
            className={`bg-orange-500 hover:bg-red-700 text-white font-bold text-xl py-2 px-4 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400 w-full mt-10 ${
